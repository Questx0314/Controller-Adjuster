...
//-----------------����LED�˿ڶ���---------------- 
#define LED_ON GPIO_ResetBits(GPIOB,GPIO_Pin_4)//DC
#define LED_OFF GPIO_SetBits(GPIOB,GPIO_Pin_4)

//-----------------OLED�˿ڶ���----------------  					   


#define OLED_SCLK_Clr() HAL_GPIO_WritePin(GPIOA, OLED_SCK_Pin, GPIO_PIN_RESET)//CLK 
#define OLED_SCLK_Set() HAL_GPIO_WritePin(GPIOA, OLED_SCK_Pin, GPIO_PIN_SET)

#define OLED_SDIN_Clr() HAL_GPIO_WritePin(GPIOA, OLED_SDA_Pin, GPIO_PIN_RESET)//DIN
